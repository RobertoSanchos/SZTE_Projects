...
<header>
    ...
    <div id="nav"><ul>
        ...
        <li><a href="szolg.php" style="color: #d0b588">Szolgáltatások</a></li>
...
<main>
    <table class="szolgaltat">
           <caption><h2>Szolgáltatás</h2></caption>
        <tr>
        ...
        <tr><td>
   <video controls width="400" id="video">
        <source src="../video/G500.mp4" type="video/mp4" />
        Nem Támogatott!
    </video></td></tr>
        <tr><td><i>forrás: www.youtube.com</i></td></tr>
    </table>
</main>
