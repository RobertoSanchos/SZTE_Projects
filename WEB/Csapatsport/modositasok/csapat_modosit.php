...
<div id="main">
    <div class="bejelent">
        <form action="csapat_modosit_function.php" method="POST" autocomplete="off">
            <fieldset>
                <legend style="font-size:25px;font-weight:bold">Csapatfelvétel</legend>
                <label><input type="hidden" name="reginev" value="<?php echo $_POST['csapat_nev']?>">
                <label><input type="text" value="<?php echo $_POST['csapat_nev']?>" name="csapnev" maxlength="50" size="25" placeholder="Név"  /></label><br /><br />
                <label><input type="text" value="<?php echo $_POST['csapat_varos']?>" name="csapvaros" maxlength="50" size="25" placeholder="Város"  /></label><br /><br />
                <label><input type="text" value="<?php echo $_POST['csapat_alapitaseve']?>" name="csapalapit" maxlength="50" size="25" placeholder="Alapítás éve"  /></label><br /><br />
                <input type="submit" name="modosit" value="Módosít" />
                <input type="submit" name="torol" value="Törlés" /> <br />
            </fieldset>
        </form>
    </div>
</div>
